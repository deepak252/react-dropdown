  ...
  return (
    <div className={itemClassNames} onClick={onClick}>
      ...
      <span className={styles.container__title}>
        <span className={styles.container__title__match}>
          {option.label.substring(0, searchQuery?.length ?? 0)}
        </span>
        <span className={styles.container__title__crop}>
          {option.label.substring(searchQuery?.length ?? 0)}
        </span>
      </span>
